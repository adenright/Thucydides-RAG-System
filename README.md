...
The system answers scholarly questions with cited passages, drawing on:

The Greek original

Public-domain English translations

Targeted commentary and lecture notes
...
Low-cost / open-source components
...
A single citation hallucination (off-by-one error)
...
Latency spikes if external APIs slow down
...
Study Mode: retrieval-only mode to help students read Greek without receiving a generated answer
